...
export class FileFunctions__getFilesResultValue0Struct extends ethereum.Tuple {
  get fileType(): string {
...
export class FileFunctions extends ethereum.SmartContract {
  static bind(address: Address): FileFunctions {
    return new FileFunctions("FileFunctions", address);
  }

  getFiles(): Array<FileFunctions__getFilesResultValue0Struct> {
    ...
    return result[0].toTupleArray<FileFunctions__getFilesResultValue0Struct>();
  }

  try_getFiles(): ethereum.CallResult<
    Array<FileFunctions__getFilesResultValue0Struct>
  > {
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<FileFunctions__getFilesResultValue0Struct>()
    );
  }
}
